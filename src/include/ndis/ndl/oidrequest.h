...
typedef struct NDIS_OID_REQUEST_SOURCE_RESERVED
{
    ...
    {
        // The request this was cloned from.
...
Routine Description:
    ...
    NdisFPassthroughOidRequest, NdisFIssueOidRequestAsync, or
    NdisFIssueOidRequestAndWait. If your LWF issues OIDs in other ways, you must
...
Return Value:
    ...
    NdisOidRequestCompletionKindLocal - the OID request was issued by
         NdisFIssueOidRequestAsync or NdisFIssueOidRequestAndWait
...
--*/
{
    ...
    case NdisOidRequestCompletionKindLocal:
        {
...
--*/
{
    ...
    Context->Completion.CompletionKind = NdisOidRequestCompletionKindLocal;
...
Return Value:
    ...
    NdisFIssueOidRequestAsync instead.)
